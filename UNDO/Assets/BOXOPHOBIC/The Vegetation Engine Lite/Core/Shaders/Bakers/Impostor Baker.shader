	...
	LOD 100
		...
		Pass
		{
			...
			)
			{
				...
				float3 worldNormal3_g76520 = normalize( float3(dot(tanToWorld0,tanNormal3_g76520), dot(tanToWorld1,tanNormal3_g76520), dot(tanToWorld2,tanNormal3_g76520)) );
...
ASEEND*/
//CHKSM=06AD151BFCA386ECB511CB73AE85F467991A48EB